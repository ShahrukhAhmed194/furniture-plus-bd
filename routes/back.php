...
Route::middleware('auth', 'isAdmin')->group(function () {
    ...
    //------------ EMAIL TEMPLATE ------------
    Route::get('/setting/email', [\App\Http\Controllers\Back\EmailSettingController::class,'email'])->name('back.setting.email');
    Route::post('/setting/email/update',[\App\Http\Controllers\Back\EmailSettingController::class,'emailUpdate'])->name('back.email.update');
    Route::get('email/template/{template}/edit', [\App\Http\Controllers\Back\EmailSettingController::class,'edit'])->name('back.template.edit');
    Route::put('email/template/update/{template}', [\App\Http\Controllers\Back\EmailSettingController::class,'update'])->name('back.template.update');

    Route::get('/setting/social',[\App\Http\Controllers\Back\SettingController::class,'social'])->name('back.setting.social');
    Route::post('/setting/update',[\App\Http\Controllers\Back\SettingController::class,'update'])->name('back.setting.update');
    ...
    Route::get('sms-settings', [App\Http\Controllers\Back\FrontendController::class, 'smsSettings'])->name('back.smsSettings');
    Route::post('update-sms-info', [App\Http\Controllers\Back\FrontendController::class, 'smsInfoUpdate'])->name('back.smsInfoUpdate');
    Route::post('add-sms-template', [App\Http\Controllers\Back\FrontendController::class, 'addSMSTemplate'])->name('back.addSMSTemplate');
    Route::post('change-app', [App\Http\Controllers\Back\FrontendController::class, 'changeApp'])->name('back.changeApp');
    ...
    Route::prefix('product')->group(function () {
        ...
        Route::post('categories/product/positon/update', [CategoryController::class, 'categoryProductPositonUpdate'])->name('back.catagory.product.position.update');
        Route::get('category/product', [CategoryController::class, 'productsOfACategory'])->name('back.category.products');
        ...
        // Stocks
         ...
         Route::get('stocks/history', [StockController::class, 'history'])->name('back.stock.history');
    ...
    Route::post('orders/print-list2', [OrderController::class, 'printList2'])->name('back.orders.printList2');
