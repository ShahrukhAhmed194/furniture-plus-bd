...
Route::post('/home-blocks', [PageController::class, 'homeBlocks'])->name('homeblocks');
...
Route::get('forget-password', [App\Http\Controllers\Auth\ForgotPasswordController::class, 'forgetPass'])->name('password.forget');
Route::post('forget-password', [App\Http\Controllers\Auth\ForgotPasswordController::class, 'sentVerificationCode'])->name('password.forget');
Route::post('forget-password/verify/otp', [App\Http\Controllers\Auth\ForgotPasswordController::class, 'verifyOtp'])->name('forget.verify.otp');
Route::get('forget-password/set/new/pass/{phone_number}/{uid}', [App\Http\Controllers\Auth\ForgotPasswordController::class, 'passwordSetPage'])->name('forget.passwordPage');
Route::post('forget-password/set/{phone_number}/{uid}', [App\Http\Controllers\Auth\ForgotPasswordController::class, 'passSetNew'])->name('forget.passSet');
...
Route::get('auth/{provider}',[\App\Http\Controllers\User\SocialLoginController::class,'redirectToProvider'])->name('social.provider');
Route::get('auth/{provider}/callback',[\App\Http\Controllers\User\SocialLoginController::class,'handleProviderCallback']);
