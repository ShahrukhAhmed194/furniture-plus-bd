                ...
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-WebInfo" role="tabpanel" aria-labelledby="v-pills-WebInfo-tab">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                            <input type="text" class="form-control form-control-sm" name="headline" value="{{$settings_g['headline'] ?? ''}}" placeholder="Website Headline">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label col-form-label-sm"><b>Whatsapp Number*: </b></label>
                            <div class="col-sm-8">
                                <input type="number" class="form-control form-control-sm" placeholder="Whatsapp Number" name="whatsapp_number" value="{{$settings_g['whatsapp_number'] ?? ''}}">
                            </div>
                        </div>
                        <div class="form-group row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control form-control-sm" name="appstore" value="{{$settings_g['appstore'] ?? '#'}}">
                                        </div>
                                        <div class="form-group">
                                            <label><b>Play Store</b></label>
                                            <input type="text" class="form-control form-control-sm" name="playstore" value="{{$settings_g['playstore'] ?? '#'}}">
                                        </div>
                                        <div class="form-group">
                    ...
                    <div class="tab-pane fade" id="v-pills-Shop" role="tabpanel" aria-labelledby="v-pills-Shop-tab">
                        <div class="row">
                            <div class="col-md-10">
                                ...
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label col-form-label-sm"><b>Stock Mange: </b></label>
                                    <div class="col-sm-6">
                                        <select class="form-control form-control-sm" name="stock_manage">
                                            <option value="1" {{ isset($settings_g['stock_manage']) && $settings_g['stock_manage']==1?'selected':'' }}>Yes</option>
                                            <option value="0" {{ isset($settings_g['stock_manage']) && $settings_g['stock_manage']==0?'selected':'' }}>No</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label col-form-label-sm"><b>Template: </b></label>
                                    <div class="col-sm-6">
                                        <select class="form-control form-control-sm" name="template">
                                            <option value="1" {{ isset($settings_g['template']) && $settings_g['template']==1?'selected':'' }}>Template 1</option>
                                            <option value="2" {{ isset($settings_g['template']) && $settings_g['template']==2?'selected':'' }}>Template 2</option>
                                            <option value="3" {{ isset($settings_g['template']) && $settings_g['template']==3?'selected':'' }}>Template 3</option>
                                        </select>
                                    </div>
                                </div>
