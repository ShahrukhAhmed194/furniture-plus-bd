    ...
    <aside class="main-sidebar noPrint" id="sidebar_accordion">
      <ul class="npnls">
        ...
        <li class="{{(Route::is('back.products.index') || Route::is('back.products.create') || Route::is('back.products.edit')) ? 'active' : ''}}"><a href="{{route('back.products.index')}}"><i class="fas fa-edit"></i> Product</a></li>
         @if(isset($settings_g['stock_manage']) && $settings_g['stock_manage']==1)
             ...
             <li>
                ...
                <ul class="sub_ms collapse {{(Route::is('back.adjustments.index') || Route::is('back.stocks.preAlert') || Route::is('back.stocks.alert') || Route::is('back.stocks.out') || Route::is('back.stock.history')) ? 'show' : ''}}" id="collapse_stock" data-parent="#sidebar_accordion">
                  <li class="{{(request()->route()->getName() == 'back.stock.history') ? 'active_sub_menu' : ''}}"><a href="{{route('back.stock.history')}}"><i class="fas fa-circle"></i> History</a></li>
                  <li class="{{(request()->route()->getName() == 'back.stocks.preAlert') ? 'active_sub_menu' : ''}}"><a href="{{route('back.stocks.preAlert')}}"><i class="fas fa-circle"></i> Pre Alert
                          <span class="badge badge-primary" style="background: red;color: yellow;">{{$stock_pre_alert_quantity_products}}</span>
                      </a></li>
                  <li class="{{(request()->route()->getName() == 'back.stocks.alert') ? 'active_sub_menu' : ''}}"><a href="{{route('back.stocks.alert')}}"><i class="fas fa-circle"></i> Alert
                          <span class="badge badge-primary" style="background: red;color: yellow;">{{$stock_alert_quantity_products}}</span>
                      </a></li>
                  <li class="{{(request()->route()->getName() == 'back.stocks.out') ? 'active_sub_menu' : ''}}"><a href="{{route('back.stocks.out')}}"><i class="fas fa-circle"></i> Stock Out
                          <span class="badge badge-primary" style="background: red;color: yellow;">{{$stock_out_products}}</span>
                      </a></li>
                </ul>
            </li>
          @endif
      ...
      <li>
          <a href="#" class="" type="button" data-toggle="collapse" data-target="#collapse_manageSite" aria-expanded="false">
              <i class="fas fa-tasks"></i> Manage Sites <i class="fas fa-chevron-right float-right text-right sub_menu_arrow"></i>
          </a>
