<tr>
    ...
    <td>
        <input type="number" name="price[]" value="{{$product->type == 'Simple' ? $product->ProductData->sale_price : 0}}" class="form-control form-control-sm price_input input_calc" style="width: 120px" >
    </td>
    <td>
