        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm" name="name" value="{{old('shipping_full_name')??''}}" required>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm" name="email" value="{{old('shipping_email')??''}}">
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control form-control-sm" name="mobile_number" value="{{old('shipping_mobile_number')??''}}" required>
                </div>
            </div>
