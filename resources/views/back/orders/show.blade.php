...
@section('master')
    <form id="order_form" action="{{route('back.orders.printList2')}}" method="POST">
        @csrf
    ...
    <form action="{{route('back.orders.update', $order->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            @foreach ($order->OrderProducts as $order_product)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <input type="number" name="sale_price[]" step="any" required class="form-control form-control-sm" value="{{$order_product->sale_price}}">
                                    </td>
                                    <td class="text-center">
                                        <input type="number" name="quantity[]" required class="form-control form-control-sm" value="{{$order_product->quantity}}">
                                    </td>
        ...
        <div class="card border-light mt-3 shadow noPrint">
            <div class="card-header">
                ...
                <button class="btn btn-info btn-sm float-right print_selected_btn2" type="button"><i class="fas fa-print"></i> Print Order</button>
            </div>
            ...
            <div class="col-md-4">
                <div class="card border-light mt-3 shadow">
                    ...
                    <div class="card-footer">
                        ...
                        <button class="btn btn-info mt-2 print_selected_btn2" type="button"><i class="fas fa-print"></i> Invoice Print</button>
...
>>>>>>> d24ab1f5f931f5d4fde695d94334fbb9a5e86df7
            </div>
        </div>
    </div>
...
@section('footer')
    ...
    <script>
        ...
        $(document).on('click', '.print_selected_btn2', function(){
