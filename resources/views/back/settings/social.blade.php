                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="switch-primary">
                                                          <input type="checkbox" class="switch switch-bootstrap status radio-check" name="facebook_check" value="1" {{ \App\Traits\SMSTrait::web('social', 'facebook_check') == 1 ? 'checked' : '' }}>
                                                          <span class="switch-body"></span>
                                                          <span class="switch-text">{{ __('Facebook Login') }}</span>
                                                        </label>
                                                    </div>

                                                    <div class="radio-show {{ \App\Traits\SMSTrait::web('social', 'facebook_check') == 0 ? 'd-none' : '' }}">

                                                        <div class="form-group ">
                                                            <label for="facebook_client_id">{{ __('App ID') }}</label> <small>({{ __('From developers.facebook.com') }})</small>
                                                            <input type="text" class="form-control" id="facebook_client_id" name="facebook_client_id" placeholder="{{ __('Enter App ID') }}" value="{{ \App\Traits\SMSTrait::web('social', 'facebook_client_id') }}">
                                                        </div>

                                                        <div class="form-group ">
                                                            <label for="facebook_client_secret">{{ __('App Secret') }}</label> <small>({{ __('From developers.facebook.com') }})</small>
                                                            <input type="text" class="form-control" id="facebook_client_secret" name="facebook_client_secret" placeholder="{{ __('Enter App Secret') }}" value="{{ \App\Traits\SMSTrait::web('social', 'facebook_client_secret') }}">
                                                        </div>
                                          ...
                                          <div id="google" class="container tab-pane"><br>
                                            ...
                                            <div class="row justify-content-center">
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="switch-primary">
                                                          <input type="checkbox" class="switch switch-bootstrap status radio-check" name="google_check" value="1" {{ \App\Traits\SMSTrait::web('social', 'google_check') == 1 ? 'checked' : '' }}>
                                                          <span class="switch-body"></span>
                                                          <span class="switch-text">{{ __('Google Login') }}</span>
                                                        </label>
                                                    </div>

                                                    <div class="radio-show {{ \App\Traits\SMSTrait::web('social', 'google_check') == 0 ? 'd-none' : '' }}">

                                                        <div class="form-group ">
                                                            <label for="google_client_id">{{ __('Client ID') }}</label> <small>({{ __('From console.cloud.google.com') }})</small>
                                                            <input type="text" class="form-control " id="google_client_id" name="google_client_id" placeholder="{{ __('Enter Client ID') }}" value="{{ \App\Traits\SMSTrait::web('social', 'google_client_id') }}">
                                                        </div>

                                                        <div class="form-group ">
                                                            <label for="google_client_secret">{{ __('Client Secret') }}</label> <small>({{ __('From console.cloud.google.com') }})</small>
                                                            <input type="text" class="form-control " id="google_client_secret" name="google_client_secret" placeholder="{{ __('Enter Client Secret') }}" value="{{ \App\Traits\SMSTrait::web('social', 'google_client_secret') }}">
                                                        </div>
