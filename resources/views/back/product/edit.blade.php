                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control form-control-sm" name="delivery" value="{{old('delivery') ?? $product->delivery}}" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label><b>Product Warranty</b></label>
                                <input type="text" class="form-control form-control-sm" name="warranty" value="{{old('warranty') ?? $product->warranty}}" required>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label><b>Nutrition*</b></label>

                                <textarea id="editorNutrition" class="form-control" name="nutrition" cols="30" rows="3" required>{{old('nutrition') ?? $product->nutrition}}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-md-4">
            <div class="card border-light mt-3 shadow">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label>Custom Label (প্রোডাক্ট এর উপর এ হাইলাইট হয়ে থাকবে)</label>
...
@section('footer')
    ...
    <script>
        ...
        $(function () {
            ...
            CKEDITOR.replace('editorNutrition', {
                height: 400,
                filebrowserUploadUrl: "{{route('imageUpload')}}?",
                extraAllowedContent: 'iframe[*]',
                allowedContent: true
