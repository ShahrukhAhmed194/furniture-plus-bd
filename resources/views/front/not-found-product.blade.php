...
<div class="{{ $container }}">
    ...
    <div class="py-10">
        <div class="border">
            <h2 class="bg-primary py-1 px-2 font-semibold text-white mb-2">Product Unavailable</h2>
            <div class="px-3 mb-2 py-10">
                ...
                find similar items or visit our <a href="/"> homepage </a> to explore our full range of products.
            </div>
        </div>
    </div>
