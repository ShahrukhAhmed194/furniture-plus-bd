...
<div class="">
    @if($template  == 3)
        ...
        <div class="grid md:grid-cols-2 items-center gap-4 md:max-w-6xl w-full">
                ...
                <form class="space-y-4 flex flex-col" method="POST" action="{{route('register')}}">
                    ...
                    <div>
                        ...
                        <div class="relative flex items-center flex-col">
                            <input type="text" required class="w-full text-sm text-gray-800 border  px-4 py-3 rounded-lg outline-blue-600 bg-slate-100 @error('name') border-red-500 @enderror" placeholder="Enter full name" value="{{ old('name') }}" name="name" />
                    ...
                    <div>
                        <label class="text-gray-800 text-sm my-2 block">Mobile Number*</label>
                        <div class="relative flex items-center flex-col">
                            <input type="number" required class="w-full text-sm text-gray-800 border  px-4 py-3 rounded-lg outline-blue-600 bg-slate-100 @error('mobile_number') border-red-500 @enderror" placeholder="Enter Number" value="{{ old('mobile_number') }}" name="mobile_number"/>
                    ...
                    <div>
                        <label class="text-gray-800 text-sm my-2 block">Email</label>
                        <div class="relative flex items-center flex-col">
                            <input type="email" class="w-full text-sm text-gray-800 border  px-4 py-3 rounded-lg outline-blue-600 bg-slate-100 @error('email') border-red-500 @enderror" placeholder="Enter email" value="{{ old('email') }}" name="email" />
                    ...
                    <div>
                        <label class="text-gray-800 text-sm my-2 block">Full Address</label>
                        <div class="relative flex items-center flex-col">
                            <input type="text" class="w-full text-sm text-gray-800 border  px-4 py-3 rounded-lg outline-blue-600 bg-slate-100 @error('address') border-red-500 @enderror" value="{{ old('address') }}" placeholder="Enter Address" name="address" />
                    ...
                    <div>
                        ...
                        <div class="relative flex items-center flex-col">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="#bbb" stroke="#bbb" class="showpass w-[18px] h-[18px] absolute right-4 top-3 cursor-pointer" viewBox="0 0 128 128">
                    ...
                    <div class="flex flex-wrap items-center my-2 justify-between gap-4">
            ...
            <div class="w-full max-w-md py-16">
                <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 border border-gray-100" method="POST" action="{{route('register')}}">
                    ...
                    <div class="flex items-center justify-between">
                        <button type="submit" class="bg-primary hover:bg-primary-light text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">Register</button>
                    </div>
